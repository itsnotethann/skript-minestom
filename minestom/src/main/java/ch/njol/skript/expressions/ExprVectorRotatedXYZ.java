...
@Name("Vector Rotated Around XYZ Axis")
@Description("Rotates a vector around the x, y, or z axis by a number of degrees.")
@Examples("set {_v} to vector(1, 0, 0) rotated around y-axis by 90 degrees")
