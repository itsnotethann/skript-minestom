...
public interface Localizer extends ViewProvider<Localizer> {
	 ...
	 */
	default void setSourceDirectories(String languageFileDirectory, @Nullable String dataFileDirectory) {
		setSourceDirectories(languageFileDirectory, dataFileDirectory, false);
	}

	void setSourceDirectories(String languageFileDirectory, @Nullable String dataFileDirectory, boolean unsafe);
