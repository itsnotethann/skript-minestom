...
final class LocalizerImpl implements Localizer {
	...
	@Override
	public void setSourceDirectories(String languageFileDirectory, @Nullable String dataFileDirectory, boolean unsafe) {
		if (!unsafe && this.languageFileDirectory != null) {
